...
<html>
<head>
<title>Wild-Life Management System | Adoption Animals Details</title>
...
$total_pages = ceil($total_rows / $no_of_records_per_page);
 ...
 ?>
								<div class="col-md-3 welcome-grid" >
									...
									<div class="wel-info">
										<h4><a href="animal-adopt.php?anid=<?php echo $row['ID'];?>"><?php echo $row['AnimalName'];?>(<?php echo $row['Breed'];?>)</a></h4>
